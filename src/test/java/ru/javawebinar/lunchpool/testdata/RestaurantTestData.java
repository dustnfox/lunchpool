package ru.javawebinar.lunchpool.testdata;
...
import static ru.javawebinar.lunchpool.model.AbstractBaseEntity.START_SEQ;
...
public class RestaurantTestData {
    ...
    public static final Restaurant REST1 = new Restaurant(REST1_ID, "Roll with the dishes", "23, Baker st.", "Japanese cousins");
    public static final Restaurant REST2 = new Restaurant(REST2_ID, "Wild boar", "13, Middle of nowhere st.", "Medieval classical cousins");
